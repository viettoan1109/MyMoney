 ...
 */
public class YearAdapter extends HorizontalCalendarBaseAdapter<DateViewHolder, Calendar> {

    public YearAdapter(HorizontalCalendar horizontalCalendar, Calendar startDate, Calendar endDate, HorizontalCalendarPredicate disablePredicate, CalendarEventsPredicate eventsPredicate) {
    ...
    protected int calculateItemsCount(Calendar startDate, Calendar endDate) {
        int years = Utils.yearsBetween(startDate, endDate) + 1;
        return years + (horizontalCalendar.getShiftCells() * 2);
    }
